          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2">
                <img src="/placeholder.svg?height=32&width=32&text=MN" alt="Metro News" className="h-8 w-8" />
              </div>
              {!isCollapsed && (
                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <button
                        ...
                        className={`group relative flex items-center w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 ${
                          isItemActive
        ...
        {!isCollapsed ? (
          ...
          <div className="space-y-2">
            ...
            <Button
              ...
              size="sm"
              onClick={handleLogout}
              className="w-full p-2 hover:bg-red-50 text-gray-600"
            >
