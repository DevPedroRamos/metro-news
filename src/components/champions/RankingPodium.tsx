...
export const RankingPodium: React.FC<RankingPodiumProps> = ({
  ...
  return <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-16 mt-[60px] mb-[60px]">
        ...
        return <Card key={person.id} className={`relative overflow-hidden ${getCardSize(position)} ${colors.gradient} ${colors.border} ${colors.glow} border-2`}>
              {/* Decorative elements */}
              {position === 1 && <>
              ...
              <CardContent className="p-4 relative">
                ...
                <div className="absolute">
                  <div className={`w-16 h-16 rounded-full ${colors.badge} text-white flex items-center justify-center shadow-lg border-4 border-white`}>
                ...
                <div className="pt-6">
                  ...
                  <div className="flex flex-col items-center mb-2">
                    <div className="relative mb-4">
                      <Avatar className="w-20 h-20 border-4 border-white shadow-lg">
                        <AvatarImage src={person.avatar_url || "/placeholder.svg"} alt={person.apelido} className="object-cover" />
                  ...
                  <div className="flex justify-center gap-3">
                    <Badge className={`${position === 1 ? "bg-yellow-200 text-yellow-800 border-yellow-300" : position === 2 ? "bg-gray-200 text-gray-700 border-gray-300" : "bg-amber-200 text-amber-800 border-amber-300"} font-medium px-3 py-1.5 text-xs`}>
                ...
                {position === 1 && <div className="absolute top-4 right-4">
