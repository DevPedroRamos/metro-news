...
const MetaSEO: React.FC = () => {
  useEffect(() => {
    ...
    const desc =
      "Resumo de pagamentos: receita, descontos e saldo negativo total.";
...
const Pagamentos: React.FC = () => {
  ...
  const receitaItemsWithIcons = useMemo(() => {
    ...
    const filteredItems = receitaItems.filter(
      (item) => item.key !== "valor_base"
    );
    return [
      ...
      <div className="max-w-7xl mx-auto space-y-6 mt-6">
        ...
        <section>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {descontoItemsWithIcons.map((item) => (
                <StatCard
                  key={item.key}
                  title={item.label}
                  value={item.value}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div
                className={`bg-white border border-gray-200 rounded-xl p-6 shadow-sm ${
                  saldoLiquido >= 0 ? "bg-green-500" : "bg-red-600"
                }`}
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm text-lime-950 font-bold">
                      Valor da Nota
                    </p>
            ...
            <Card className="bg-white border border-gray-200 shadow-sm">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-gray-600">
                  Nenhum histórico de pagamento anterior foi encontrado.
                </p>
              </CardContent>
            </Card>
          )}
